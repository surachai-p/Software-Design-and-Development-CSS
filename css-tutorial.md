...
```
![image](https://github.com/user-attachments/assets/8628dd18-df5c-4b87-93bb-95aa9d17d376)
...
<body>
    <div class="dashboard">
        ...
        <main class="main-content">
            <div class="stats-grid">
                <div class="stat-card"><h3>ยอดขายรวม</h3><p>฿200,000</p></div>
                <div class="stat-card"><h3>จำนวนออเดอร์</h3><p>1,548</p></div>
                <div class="stat-card"><h3>ลูกค้าใหม่</h3><p>60</p></div>
            </div>
            <div class="chart-container">
...
```
![image](https://github.com/user-attachments/assets/f636dd8c-3cd8-47af-8d4f-9168573b247b)

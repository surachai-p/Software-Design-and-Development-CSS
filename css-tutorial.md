...
![g2](https://github.com/user-attachments/assets/4b339c34-efd2-471e-9836-1f0cc44aa235)
...
<body>
    <div class="stats-container">
        <div class="stat-box">
            <div class="stat-number">1,999</div>
            <div class="stat-label">ผู้ใช้งาน</div>
        </div>
        <div class="stat-box">
            <div class="stat-number">6.8K</div>
            <div class="stat-label">ยอดขาย</div>
        </div>
        <div class="stat-box">
...
```
[บันทึกภาพหน้าจอของผลลัพธ์การทดลอง]
![G3](https://github.com/user-attachments/assets/363f850f-78ec-4514-9105-56ab23ca894d)
